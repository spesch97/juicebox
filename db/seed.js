...
async function createInitialPosts() {
  try {
    ...
    await createPost({
      authorID: sandra.id,
      title: "The Beach is too sandy!",
      content:
        "We went to the beach today and there was too much sand that followed us home.",
        tags: ["#happy", "#youcandoanything"]
    });

    await createPost({
      authorId: glamgal.id,
      title: "My life in the spotlight is hard",
      content: "Being a glam girl isn't actually fun.",
      tags: ["#happy", "#youcandoanything"]
    });
